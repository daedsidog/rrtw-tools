...
struct is_streamable<
    ...
    enable_if_t<
        ...
        std::is_convertible<T, dcc::fmt::basic_string_view<Char>>::value ||
...
inline bool write(std::filebuf& buf, dcc::fmt::string_view data) {
  FILE* f = get_file(buf);
  if (!f) return false;
  print(f, data);
  return true;
}
inline bool write(std::wfilebuf&, dcc::fmt::basic_string_view<wchar_t>) {
  return false;
}
...
/**
  ...
  **Example**::
    ...
    dcc::fmt::print("Current thread id: {}\n",
               dcc::fmt::streamed(std::this_thread::get_id()));
  \endrst
 */
template <typename T>
...
/**
  ...
  **Example**::
    ...
    dcc::fmt::print(cerr, "Don't {}!", "panic");
  \endrst
 */
FMT_MODULE_EXPORT template <typename... T>
void print(std::ostream& os, format_string<T...> fmt, T&&... args) {
  vprint(os, fmt, dcc::fmt::make_format_args(args...));
}
...
void print(std::wostream& os,
           ...
           Args&&... args) {
  vprint(os, fmt, dcc::fmt::make_format_args<buffer_context<wchar_t>>(args...));
}
