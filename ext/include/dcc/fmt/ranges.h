...
struct is_std_string_like<dcc::fmt::basic_string_view<Char>> : std::true_type {};
...
struct formatter<TupleT, Char,
                 enable_if_t<dcc::fmt::is_tuple_like<TupleT>::value &&
                             dcc::fmt::is_tuple_formattable<TupleT, Char>::value>> {
 private:
...
struct formatter<
    R, Char,
    enable_if_t<
        conjunction<dcc::fmt::is_range<R, Char>
...
/**
  ...
  **Example**::
    ...
    dcc::fmt::print("{}", dcc::fmt::join({1, 2, 3}, ", "));
    // Output: "1, 2, 3"
  \endrst
 */
template <typename T>
